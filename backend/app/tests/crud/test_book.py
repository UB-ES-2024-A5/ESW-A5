...
from app.models import (Book, BookBase, BookCreate, UserCreate, Account)
...
def test_create_book_all_mandatory_fields(db:Session,create_account):
    ...
    book_in = BookCreate(title=title,author=author,genre1=genre1,synopsis=synopsis,isbn=isbn,account_id=account_id_in)
